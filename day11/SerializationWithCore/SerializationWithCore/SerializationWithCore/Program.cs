...
namespace SerializationWithCore
{
    internal class Program
    {
        static void Main()
        {
            ...
            //BinaryFormatterDeSerialize();

            SoapFormatterSerialize();
            SoapFormatterDeSerialize();
...
#pragma warning restore SYSLIB0011 // Type or member is obsolete
        ...
        private static void BinaryFormatterDeSerialize()
        {
            BinaryFormatter bf = new BinaryFormatter();
...
#pragma warning restore SYSLIB0011 // Type or member is obsolete
        ...
        private static void SoapFormatterSerialize()
        {
            Class1 o = new Class1();
            o.i = 100;
            o.P1 = "aaa";
        ...
        private static void SoapFormatterDeSerialize()
        {
            SoapFormatter sf = new SoapFormatter();
